...
public class SubjectKnowledgeParser implements SqlParser<SubjectKnowledge, String> {
    public String createInsertQuery(SubjectKnowledge subjectKnowledge) {
        return "INSERT INTO Znajomosc_Przedmiotu_Maturalnego VALUES ('" +
                "null" + "', '" +
